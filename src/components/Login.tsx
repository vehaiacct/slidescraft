    ...
    return (
        <div className="min-h-screen w-full flex-center bg-slate-950 relative overflow-hidden">
            ...
            <div className="w-full max-w-md px-6 z-10 animate-fade-in">
                ...
                <div className="glass premium-card p-6 md:p-10 space-y-6 md:space-y-8">
                    <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
                        <div className="space-y-2">
                            <label className="text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">Email Address</label>
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-900/50 border border-slate-800 rounded-xl md:rounded-2xl py-3 md:py-4 pl-12 pr-4 text-sm focus:outline-none focus:border-indigo-500/50 focus:ring-4 focus:ring-indigo-500/10 transition-all placeholder:text-slate-600"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center px-1">
                                <label className="text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-widest">Password</label>
                                <a href="#" className="text-[9px] md:text-[10px] font-bold text-indigo-400 hover:text-indigo-300 transition-colors uppercase tracking-wider">Forgot?</a>
                            </div>
                            <div className="relative group">
                        ...
                        <button
                            type="submit"
                            className="w-full py-3 md:py-4 bg-white text-slate-950 rounded-xl md:rounded-2xl font-black text-xs md:text-sm tracking-widest uppercase hover:bg-indigo-50 transition-all shadow-xl shadow-white/5 flex-center gap-2 group"
                        >
                            <span>Sign In</span>
                    ...
                    <div className="grid grid-cols-2 gap-3 md:gap-4">
                        <button
                            ...
                            className="flex-center gap-2 md:gap-3 py-2.5 md:py-3 border border-slate-800 rounded-xl hover:bg-slate-900 transition-all text-[10px] md:text-xs font-bold text-slate-300 disabled:opacity-50"
                        >
                            {isSocialLoading === 'github' ? <div className="w-4 h-4 border-2 border-indigo-400 border-t-transparent rounded-full animate-spin" /> : <Github size={16} />}
                            <span>Github</span>
                        </button>
                        <button
                            type="button"
                            ...
                            className="flex-center gap-2 md:gap-3 py-2.5 md:py-3 border border-slate-800 rounded-xl hover:bg-slate-900 transition-all text-[10px] md:text-xs font-bold text-slate-300 disabled:opacity-50"
                        >
                            {isSocialLoading === 'google' ? <div className="w-4 h-4 border-2 border-indigo-400 border-t-transparent rounded-full animate-spin" /> : (
